...
Robot starts in r4
Env starts with alice_r4

# Environment Assumptions
if you were in r4 then do not alice_r2
if you were in r4 then do not alice_r3
if you were in r2 then do not alice_r1
if you were in r3 then do not alice_r1
